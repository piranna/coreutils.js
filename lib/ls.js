...
function LsStream(args)
{
  if(!(this instanceof LsStream)) return new LsStream(args);

  LsStream.super_.call(this, {objectMode: true});
...
inherits(LsStream, Readable)

LsStream.prototype._read = function(size){};
